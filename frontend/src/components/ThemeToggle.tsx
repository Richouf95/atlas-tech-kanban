...
<div className="flex items-center">
  <label className="inline-flex items-center cursor-pointer themeSwitchBtn">
    ...
    />
    <div
      className={`relative flex items-center justify-between w-14 h-7 rounded-full transition-colors duration-300 ease-in-out ${
    ...
    >
      ...
      />
      <div
        className={`absolute top-0.5 left-[4px] w-6 h-6 rounded-full transition-transform duration-300 ease-in-out ${
          theme === "light"
